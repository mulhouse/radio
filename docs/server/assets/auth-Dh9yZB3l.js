...
const setAppwriteSessionCookiesFn = createServerFn({ method: "POST" }).inputValidator(setAppwriteSessionCookiesSchema).handler(setAppwriteSessionCookiesFn_createServerFn_handler, async ({ data }) => {
...
const signOutFn = createServerFn({ method: "GET" }).handler(signOutFn_createServerFn_handler, async () => {
	try {
...
const forgotPasswordFn = createServerFn({ method: "POST" }).inputValidator(forgotPasswordSchema).handler(forgotPasswordFn_createServerFn_handler, async ({ data }) => {
	const { email } = data;
	const { account } = createAdminClient();
	try {
...
const resetPasswordFn = createServerFn({ method: "POST" }).inputValidator(resetPasswordSchema).handler(resetPasswordFn_createServerFn_handler, async ({ data }) => {
...
export { signInFn as a, resetPasswordFn as i, forgotPasswordFn as n, signOutFn as o, getCurrentUser as r, signUpFn as s, authMiddleware as t };

//# sourceMappingURL=auth-Dh9yZB3l.js.map